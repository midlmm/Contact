...
{
    public static void Add(this Inventory inventory, ItemConfig itemConfig, int count = 1)
    {
    ...
    public static void Add(this Inventory inventory, Vector2Int slotCoordinates, ItemConfig itemConfig, int count = 1)
    {
    ...
    public static bool Remove(this Inventory inventory, ItemConfig itemConfig, int count = 1, bool invokeDrop = true)
    {
    ...
    public static bool Remove(this Inventory inventory, Vector2Int slotCoordinates, ItemConfig itemConfig, int count = 1, bool invokeDrop = true)
    {
        var size = inventory.Size;
    ...
    public static bool CheckItems(this Inventory inventory, ItemConfig itemConfig, int count = 1)
    {
    ...
    public static void AddToSlotsWithSameItems(Inventory inventory, ItemConfig itemConfig, int count, out int remainingCount)
    {
        var size = inventory.Size;
        var rowLenght = size.x;
    ...
    public static void AddToFirstAvalableSlot(Inventory inventory, ItemConfig itemConfig, int count, out int remainingCount)
    {
        var size = inventory.Size;
        var rowLenght = size.x;
        remainingCount = count;
